					...
					<div class="card-body px-lg-5 py-lg-5 position-relative">
						...
						<form method="post" action="{{url('send/ppv')}}" id="formSendPPV">
							...
							@foreach ($paymentGatewaysSubscription as $payment)
								...
								<div id="mercadopagoContainerPPV" class="@if ($allPayments->count() != 1) display-none @endif">
									<div id="mercadopagoButton" class="margin-bottom-10">
										<!-- A Mercado Pago Element will be inserted here. -->
									</div>
									<!-- Used to display form errors. -->
									<div id="card-errorsPPV" class="alert alert-danger display-none" role="alert"></div>
								</div>
